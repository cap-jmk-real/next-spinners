...
import { SpinnerHeroClient } from "../components/spinner-catalog-client";
...
- **[Live gallery (by origin)](/reference/spinner-gallery):** every frame spinner, rendered in the browser
